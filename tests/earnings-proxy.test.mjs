...
test('exported earnings page and assets load while source and unknown API paths stay inaccessible', async () => {
  ...
  assert.equal(response.status, 200);
  for (const path of ['/server.js', '/package.json', '/api/earnings-boards.js', '/earnings/package.json', '/earnings-tracker/db/sqlite.ts', '/earnings-tracker/api/missing', '/earnings-tracker/api/boards/extra']) {
